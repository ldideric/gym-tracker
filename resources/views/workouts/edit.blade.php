        ...
        <div class="mb-44">
            <div class="container w-auto m-5 p-4 text-white bg-slate-900 rounded-lg">
                <div class="mb-6">
                    ...
                    <label>
                        <input type="text" name="name" placeholder="Workout Name" class="appearance-none rounded w-full py-2 px-3 text-white bg-slate-700 leading-tight outline-none active:border-rose-600 focus:border-rose-600" value="{{ $workout->name }}">
                    </label>
                    @if ($errors->has('name'))
