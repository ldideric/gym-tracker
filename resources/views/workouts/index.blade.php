...
@section('content')
    ...
    <div class="container w-auto p-6 text-white">
        ...
        <p class="mb-4">Here you can view and manage your current
            <span class="font-bold text-rose-600">workout</span> plans, as well as create new ones to keep pushing your fitness goals.
        </p>
        <p>Start your fitness journey
            <span class="font-bold text-rose-600">today</span> and take the first step towards a healthier lifestyle!
        </p>
    </div>
